...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "insposolutions.io", uriPort = 80)
...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        given(beerService.getById(any(),any())).willReturn(BeerDto.builder().build());
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                        .param("iscold", "yes") // this is for request parameter documentation.
                                                            // just showing here how to document if request param
    ...
    void getBeerByUpc() throws Exception {
        mockMvc.perform(get("/api/v1/beerUpc/abc").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
